...
void Renderer::begin_render_pass(Reference<RenderCommandBuffer> command_buffer, Reference<RenderPass> render_pass, bool explicit_clear)
{
...
void Renderer::render_geometry(Reference<RenderCommandBuffer> cmd_buffer, Reference<Pipeline> pipeline, Reference<UniformBufferSet> ubs,
...
Reference<ShaderLibrary> Renderer::get_shader_library() {
    return renderer_data->shader_library;
}
