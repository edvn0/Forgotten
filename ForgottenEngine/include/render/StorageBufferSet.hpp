...
namespace ForgottenEngine {
	...
	public:
		...
		Reference<StorageBuffer> get(uint32_t binding, uint32_t set = 0, uint32_t frame = 0) { return get_impl(binding, set, frame); };
		void set(Reference<StorageBuffer> storageBuffer, uint32_t set = 0, uint32_t frame = 0) { return set_impl(storageBuffer, set, frame); };
