...
namespace ForgottenEngine {
    ...
    public:
        ...
        virtual void AddResizeCallback(const std::function<void(Reference<Framebuffer>)>& func) = 0;
        ...
        virtual Reference<Image2D> GetImage(uint32_t attachmentIndex = 0) const = 0;
        virtual Reference<Image2D> GetDepthImage() const = 0;
